        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{route('products.update', $product)}}" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="creNamePro" class="form-control" name="nameProduct" value="{{ $product->nameProduct }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" aria-label="Default select example" name="brand" value="{{$product->brand}}">
                            ...
                            <option value="{{$brand->brand}}" {{ $product->brand == $brand->brand ? 'selected' : ''}}>{{$brand->brand}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
